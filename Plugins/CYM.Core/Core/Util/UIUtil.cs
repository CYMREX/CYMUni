...
namespace CYM
{
    ...
    public partial class UIUtil
    {
        ...
        {
#if UNITY_EDITOR
            return AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kStandardSpritePath);
#else
            return null;
#endif
        }
        ...
        {
#if UNITY_EDITOR
            return AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kBackgroundSpritePath);
#else
            return null;
#endif
        }
        ...
        {
#if UNITY_EDITOR
            return AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kMaskPath);
#else
            return null;
#endif
        }
        ...
        static string GetColor(float? number, bool isReverseCol = false)
        {
            ...
            if (number > 0)
            {
                if (!isReverseCol) return Const.COL_Green;
                else return Const.COL_Red;
            }
            else if (number < 0)
            {
                if (!isReverseCol) return Const.COL_Red;
                else return Const.COL_Green;
            }
            else return Const.COL_Yellow;
        }
        #endregion
        ...
        #region UIColor
        //国家颜色
        public static string Nation(string name) => string.Format(ColorFormat, name, Const.COL_Yellow);
        //城市颜色
        public static string Castle(string name) => string.Format(ColorFormat, name, Const.COL_Green);
        //宗教
        public static string Religion(string name) => string.Format(ColorFormat, name, Const.COL_Yellow);
        //贸易
        public static string TradeRes(string name) => string.Format(ColorFormat, name, Const.COL_Grey);
        //黄色
        public static string Yellow(string name) => string.Format(ColorFormat, name, Const.COL_Yellow);
        public static string Yellow(float number) => Yellow(number.ToString());
        //红色
        public static string Red(string name) => string.Format(ColorFormat, name, Const.COL_Red);
        public static string Red(float number) => Red(number.ToString());
        //绿色
        public static string Green(string name) => string.Format(ColorFormat, name, Const.COL_Green);
        public static string Green(float number) => Green(number);
        //灰色
        public static string Grey(string name) => string.Format(ColorFormat, name, Const.COL_Grey);
        ...
        // 天枰颜色，P=Percent
        public static string ApparP(float? percent, string colorLeft = Const.COL_Yellow, string colorRight = Const.COL_Green)
        {
            if (percent == null) return "";
        ...
        public static string Indent(string str) => Const.STR_Indent + str;
        #endregion
