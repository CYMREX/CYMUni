...
namespace CYM
{
    public class BaseBGMMgr : BaseGFlowMgr
    {
        ...
        {
            return CreateConnection(BaseGlobal.RsMusic.GetStrsByCategory(Config.StartMusics));
        }
        protected virtual SoundConnection CreateCreditsBGM()
        {
            return CreateConnection(BaseGlobal.RsMusic.GetStrsByCategory(Config.CreditsMusics));
        }
        protected virtual SoundConnection CreateBattleBGM()
        {
            return CreateConnection(BaseGlobal.RsMusic.GetStrsByCategory(Config.BattleMusics), SoundManager.PlayMethod.ShufflePlayThroughWithRandomDelayInRange);
        }
        #endregion
