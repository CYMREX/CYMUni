...
namespace CYM
{
        ...
        where TUnit : BaseUnit
    {
        ...
        protected float GetAttrVal(Type type) => Unit.AttrMgr.GetVal(EnumTool<Type>.Int(type));
    }
    #endregion
        ...
        where TUnit : BaseUnit
    {
        ...
        #region 必须重载的函数
        protected virtual float GetAttrVal(Type type) => Unit.AttrMgr.GetVal(EnumTool<Type>.Int(type));
        #endregion
    }
    #endregion
