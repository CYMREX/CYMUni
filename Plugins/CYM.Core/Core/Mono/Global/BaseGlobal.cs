...
namespace CYM
{
    ...
    public partial class BaseGlobal : BaseCoreMono
    {
        ...
        public static RsCacher<Material> RsMaterial { get; private set; } = new RsCacher<Material>(Const.BN_Materials);
        public static RsCacher<GameObject> RsPrefab { get; private set; } = new RsCacher<GameObject>(Const.BN_Prefab);
        public static RsCacher<GameObject> RsPerfom { get; private set; } = new RsCacher<GameObject>(Const.BN_Perform);
        public static RsCacher<Sprite> RsIcon { get; private set; } = new RsCacher<Sprite>(Const.BN_Icon);
        public static RsCacher<Sprite> RsHead { get; private set; } = new RsCacher<Sprite>(Const.BN_Head);
        public static RsCacher<AudioClip> RsAudio { get; private set; } = new RsCacher<AudioClip>(Const.BN_Audio);
        public static RsCacher<AudioClip> RsMusic { get; private set; } = new RsCacher<AudioClip>(Const.BN_Music);
        public static RsCacher<GameObject> RsUI { get; private set; } = new RsCacher<GameObject>(Const.BN_UI);
        public static RsCacher<VideoClip> RsVideo { get; private set; } = new RsCacher<VideoClip>(Const.BN_Video);
        public static RsCacher<RuntimeAnimatorController> RsAnimator { get; private set; } = new RsCacher<RuntimeAnimatorController>(Const.BN_Animator);
        public static RsCacher<Sprite> RsBG { get; private set; } = new RsCacher<Sprite>(Const.BN_BG);
        public static RsCacher<Texture2D> RsTexture { get; private set; } = new RsCacher<Texture2D>(Const.BN_Texture);
        public static RsCacher<Sprite> RsIllustration { get; private set; } = new RsCacher<Sprite>(Const.BN_Illustration);
        #endregion
        ...
        {
            transform.position = Const.VEC_GlobalPos;
        }
#endif
        ...
        public static void CreateConfig<T>(T _ins) where T : ScriptableObjectConfig<T>
        {
            ...
            if (_ins == null)
            {
               ...
               UnityEditor.AssetDatabase.CreateAsset(_ins, string.Format(Const.Format_ConfigAssetPath, fileName));
                _ins.OnCreated();
            }
        }
