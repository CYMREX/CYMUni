...
namespace CYM
{
    ...
    internal static class CommandDatabase
    {
        ...
        {
            List<Assembly> data = new List<Assembly>() { typeof(Console).Assembly };
            methodInfoCache = commands ?? data
                ...
                .ToDictionary(method => method.GetCustomAttribute<ConsoleCommandAttribute>().Alias ?? method.Name, System.StringComparer.OrdinalIgnoreCase);
        }
        internal static void RegisterUpdateCommands(Dictionary<string, MethodInfo> commands = null)
        {
            ...
            methodUpdateCache = commands ?? data
                ...
                .ToDictionary(method => method.GetCustomAttribute<ConsoleUpdateAttribute>().Alias ?? method.Name, System.StringComparer.OrdinalIgnoreCase);
        }
    }
    ...
    public partial class Console : MonoBehaviour
    {
        ...
        {
            Initialize();
            void Initialize(Dictionary<string, MethodInfo> commands = null)
            {
                if (Ins) return;
                ...
                Ins.guiProxy = gameObject.AddComponent<OnGUIProxy>();
        ...
        public static Console Ins { get; private set; }
