...
namespace CYM.UI
{
    public static class UIObjectCreator
    {
        ...
        static private DefaultControls.Resources GetStandardResources()
        {
            ...
            {
                s_StandardResources.standard = AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kStandardSpritePath);
                s_StandardResources.background = AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kBackgroundSpritePath);
                s_StandardResources.inputField = AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kInputFieldBackgroundPath);
                s_StandardResources.knob = AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kKnobPath);
                s_StandardResources.checkmark = AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kCheckmarkPath);
                s_StandardResources.dropdown = AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kDropdownArrowPath);
                s_StandardResources.mask = AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kMaskPath);
            }
        ...
        static public GameObject CreateNewUI()
        {
            ...
            root.layer = LayerMask.NameToLayer(Const.kUILayerName);
        ...
        static Image AddImage(GameObject go, Image.Type type)
        {
            ...
            temp.sprite = AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kStandardSpritePath);
            temp.type = type;
        ...
        static RawImage AddRawImage(GameObject go)
        {
            ...
            temp.texture = AssetDatabase.GetBuiltinExtraResource<Sprite>(Const.kStandardSpritePath).texture;
            temp.color = PanelColor;
            return temp;
        }
